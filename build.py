...
/* 关掉缩放：双击缩放靠 touch-action，捏合靠下面那段手势拦截；
   text-size-adjust 防止 iOS 横屏时自动放大正文。 */
html{touch-action:manipulation;-webkit-text-size-adjust:100%}
</style>
<script>
/* iOS Safari 自 iOS 10 起故意无视 user-scalable=no，只能拦手势事件。
   主屏 standalone 模式下 meta 是生效的，浏览器里打开则靠这段兜底。 */
(function(){
